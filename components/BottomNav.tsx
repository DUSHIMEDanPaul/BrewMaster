...
const BottomNav: React.FC<BottomNavProps> = ({ currentPage, onNavigate, cartCount, user }) => {
  const buyerTabs: { id: Page; label: string; icon: React.ReactNode }[] = [
  ...
  const sellerTabs: { id: Page; label: string; icon: React.ReactNode }[] = [
